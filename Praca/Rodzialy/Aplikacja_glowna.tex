...
Na potrzeby niniejszej pracy stworzono aplikacjê w jêzyku \textit{Python}, która umo¿liwia pobieranie i
...
zmiany w funkcji czasu, zaimplementowanych z wykorzystnaiem biblioteki \textit{Matplotlib}, które u³atwiaj¹ ocenê ogólnej zmiennoœci rytmu serca.
...
jednorazowo i przetwarza go w ca³oœci. Analiza obejmuje pe³en zestaw danych,
bez dzielenia go na pakiety. Po zakoñczeniu przetwarzania u¿ytkownik otrzymuje
...
arytmetycznej trzech ostatnich interwa³ów RR. Mechanizm ten zapobiega
