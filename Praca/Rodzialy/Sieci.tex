...
Nowoczesne metody analizy, takie jak uczenie maszynowe, mog¹ znacz¹co przyczyniæ siê do lepszego zrozumienia zjawiska RSA, które pomimo wieloletnich badañ wci¹¿ budzi liczne pytania \cite{Morales-RSASVM}. Dziêki ich wykorzystaniu mo¿liwe jest odkrycie nowych wzorców i mechanizmów stoj¹cych za tym zjawiskiem.

Autorzy publikacji \cite{Morales-RSASVM} podjêli próbê zbadania zale¿noœci miêdzy RSA a HRV, wykorzystuj¹c metody uczenia maszynowego. Zastosowali model SVM (Support Vector Machine) do przewidywania przysz³ych wartoœci HRV na podstawie sygna³ów oddechowych, co pozwoli³o na ocenê wp³ywu oddechu na zmiennoœæ rytmu serca. Dziêki zastosowaniu dwóch funkcji j¹dra  – liniowego i radialnego (RBF) – model umo¿liwi³ analizê zarówno prostych (liniowych), jak i bardziej z³o¿onych (nieliniowych) zale¿noœci. Wyniki wykaza³y, ¿e RSA w badanych przypadkach opiera³ siê g³ównie na mechanizmach liniowych, a wp³yw komponentów nieliniowych by³ ma³o znacz¹cy. Oznacza to, ¿e wiêkszoœæ zmian w rytmie serca mo¿na wyjaœniæ bez odwo³ywania siê do bardziej z³o¿onych interakcji miêdzy oddechem a HRV.

Inne podejœcie do analizy RSA z wykorzystaniem metod uczenia maszynowego zosta³o przedstawione w pracy \cite{Lahr-RSA}. Autorzy zastosowali algorytm drzew decyzyjnych CART (Classification and Regression Tree), który umo¿liwi³ hierarchiczne uporz¹dkowanie czynników wp³ywaj¹cych na wystêpowanie RSA oraz okreœlenie ich znaczenia. 

Wyniki analizy wskaza³y, ¿e najistotniejszym czynnikiem determinuj¹cym RSA jest wiek. Kolejnymi wa¿nymi zmiennymi by³y têtno (HR) oraz indeks masy cia³a (BMI). Drzewa decyzyjne pomog³y tak¿e zobrazowaæ, w jaki sposób ró¿ne poziomy tych zmiennych wp³ywaj¹ na wystêpowanie RSA.
