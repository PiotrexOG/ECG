...
Warto jednak zaznaczyÊ, øe wiÍksza liczba warstw ukrytych lub neuronÛw w sieci nie zawsze oznacza lepsze rezultaty. ZwiÍkszanie liczby warstw lub neuronÛw moøe prowadziÊ do problemÛw, takich jak przeuczenie (ang. overfitting), gdzie sieÊ zbyt dok≥adnie dopasowuje siÍ do danych treningowych kosztem generalizacji na nowych danych. Ponadto, wiÍksza liczba warstw oznacza wyøsze wymagania obliczeniowe i wiÍkszπ z≥oøonoúÊ optymalizacji.
...
\subsubsection{Warstwa w pe≥ni po≥πczona (fully connected layer)}
