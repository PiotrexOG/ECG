...
% Lorem ipsum
\section{Wyznaczanie szczytów R \small{(autor: Jakub Wojtalewicz)}}
Identyfikacja szczytów R jest kluczowym etapem analizy sygna³u EKG. Na ich podstawie oblicza siê wiêkszoœæ metryk zwi¹zanych z analiz¹ zmiennoœci rytmu serca. W tym podrodziale opisano zastosowane w aplikacji metody ich wyznaczania: algorytm Pan-Tompkins oraz model g³êbokiej sieci neuronowej.
...
œrodkowoprzepustowa, ró¿niczkowanie, kwadratowanie, okno uœredniaj¹ce,
ustalenie progów i detekcja szczytów R \cite{Fariha-PanTompkins}. Dodatkowo,
aby dok³adnie dopasowaæ wykryte szczyty do rzeczywistych najwy¿szych wartoœci
sygna³u, wprowadzono dodatkowy krok, polegaj¹cy na sprawdzaniu otoczenia
wykrytego szczytu.

\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/Pan-Tomkins-scheme.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/Pan Tompkins_raw.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/Pan-Tompkins filtered.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/PanTompkins_derivative.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/Pan_tomkins_squared.png}
...
Okno uœredniaj¹ce ma na celu wyg³adzenie i uœrednienie sygna³u w okreœlonym
przedziale - oknie czasowym. Proces ten polega na obliczaniu œredniej wartoœci
...
charakterystycznych za³amków QRS. Uœrednianie pomaga równie¿ w eliminacji
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/Pan_tomkins_integrated.png}
    \caption{Fragment sygna³u EKG z czujnika Polar H10 po oknie uœredniaj¹cym}
...
obliczany jako œrednia wartoœæ sygna³u z poprzedniego kroku, powiêkszona o
0,6-krotnoœæ odchylenia standardowego tego sygna³u.\\
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/Pan Tomkins without refining.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/Pan_tomkins_final.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/U-net_small.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{Rysunki/unet-postprocess.png}
...
W ramach modyfikacji wzglêdem pierwotnej implementacji zmieniono sposób korekty
...
z powodu zamiany polaryzacji elektrod. Metodê wykrywania szczytów obudowano
w³asnym interfejsem, który by³ wspomniany w podsekcji \ref{subsec:wykrywacz}
...
% który by³ wspomniany w podsekcji \ref{subsec:wykrywacz} 
\FloatBarrier
\section{Modele neuronowe do wyznaczania miar HRV \small{(autor: Jakub Wojtalewicz)}}
...
\begin{figure}[ht]
    ...
    \caption{Schemat modelu wyznaczaj¹cego miary HRV na podstawie interwa³ów RR}
    \label{fig/rr_siec}
\end{figure}
