...
\cite{MUzairZahid-UNET}. Jej budowa oraz blok post processingu przedstawiony,  jest na Rys. \ref{fig/UNet}
...
Œcie¿ka koduj¹ca odpowiada za ekstrakcje istotnych cech sygna³u. Na ka¿da warstwê tej œcie¿ki sk³ada siê warstwa splotowa, która dokonuje jednoczeœnie operacji splotu i dwukrotnej redukcji wektora wejœciowego. 
