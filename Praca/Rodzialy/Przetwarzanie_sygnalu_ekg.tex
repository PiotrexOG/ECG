...
W ramach pracy opracowano model sieci neuronowej typu end-to-end, której celem
by³o przewidywanie parametrów HRV na podstawie surowego sygna³u EKG. Do
implementacji sieci wykorzystano wysokopoziomowe API biblioteki {tensorflow} o
nazwie Keras \cite{TensorFlow-Keras}.

Model oparto o trzy jednowymiarowe warstwy splotowe (Conv1D), z których po
ka¿dej dokonywano nromalizacje wsadow¹ (BatchNormalization) oraz operacje
poolingu (MaxPooling1D). Nastêpnie u¿yto
