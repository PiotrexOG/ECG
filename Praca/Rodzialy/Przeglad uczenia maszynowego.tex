...
nadzorowanych popularne s¹ SVM (ang. Support Vector Machines), KNN (ang. K-Nearest
...
(ang. Long Short-Term Memory), które s¹ bardziej odporne na zak³ócenia i lepiej
...
(K-Nearest Neighbors), SVM (ang. Support Vector Machines) oraz las losowy (Random
...
ró¿ne modele oparte na splotowych sieciach neuronowych (CNN) w celu oceny
