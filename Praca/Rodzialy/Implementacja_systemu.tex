...
Silny efekt RSA powodowa³ wzrost mocy sygna³u w tym samym paœmie
...
Na podstawie literatury oraz analizy heurystycznej ustalono, ¿e najlepsze
...
zdefiniowano próg (\textit{threshold}) jako œredni¹ wartoœæ przefiltrowanego
...
odleg³oœæ (\textit{distance}) miêdzy kolejnymi szczytami jako liczbê próbek
odpowiadaj¹c¹ czasowi trwania po³owy jednego cyklu oddechowego.

W celu detekcji do³ków sygna³ zosta³ odwrócony poprzez zmianê znaku wszystkich
...
szczegó³owo w Rozdziale \ref{P-Tomkins}.
...
Na wykresie przedstawiono widmow¹ gêstoœæ mocy (Power Spectral Density, PSD),
...
moc w paœmie ULF (Ultra-Low Frequency, poni¿ej 0,003 Hz).
\begin{figure}[ht]
    \centering
...
precyzyjn¹ analizê w interesuj¹cym zakresie czêstotliwoœci. Kluczowe parametry
falki zosta³y dostosowane w nastêpuj¹cy sposób:
\begin{itemize}
...
Na zamieszczonym obrazie przeanalizowano tê sam¹ 5-minutow¹ próbkê
zarejestrowan¹ podczas snu, która by³a omówiona w rozdziale dotycz¹cym
...
do pasma LF. Zale¿noœæ tê wyraŸnie pokazuj¹ zarówno skalogram, jak i wykresy
...
0,25 sekundy \ref{fig:lf_avg} . Ze wzglêdu na du¿e wahania mocy w krótkich
...
opisanych we wczeœniejszym rozdziale, wybrano œredni¹ gaussowsk¹ jako domyœlny
...
danych historycznych, co powoduje przesuniêcie (tzw. lag) wzglêdem
