...
\begin{itemize}
    ...
    \item \textbf{Czêstotliwoœæ centralna:} \(C = 0.22\) — parametr ten skupia energiê falki na kluczowym dla analizy przedziale czêstotliwoœci, zapewniaj¹c precyzyjn¹ reprezentacjê sygna³u.
\end{itemize}
